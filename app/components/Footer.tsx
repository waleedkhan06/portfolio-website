  ...
  return (
    <footer className="py-6 bg-soft-gold dark:bg-gray-900 text-white shadow-lg">
      <div className="container mx-auto text-center text-gray-300">
        <p className='text-black dark:text-cyan-600'>&copy; {currentYear}
           Waleed Khan. All Rights Reserved.</p>
      ...
      {isVisible && (
        <button 
          onClick={scrollToTop} 
          className="fixed bottom-6 right-6 bg-black text-soft-gold dark:bg-black
           dark:text-bright-cyan p-3 rounded-full shadow-lg 
